...
/*
  ...
  If NDEBUG is not defined, a check for zero length columns can be activated
...
/*
  ...
  If NDEBUG is not set and the WRNATT flag is set, a warning will be issued if
...
/*
  ...
  If NDEBUG is not defined and the WRNZERO flag is set, the routine will
